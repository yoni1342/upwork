        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <img src="/assets/icon.png" alt="Upwex Logo" className="h-8 w-8 mr-3" />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 col-span-full">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Welcome to Upwex!</h2>
            <p className="text-gray-600">
              You're now logged in and ready to start using Upwex. Here you can manage your profile,
              view your projects, and access all the features available to you.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 col-span-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition text-center">
                ...
                <p className="text-sm font-medium text-gray-600">Complete Profile</p>
              </button>
              ...
              <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-green-500 hover:bg-green-50 transition text-center">
                ...
                <p className="text-sm font-medium text-gray-600">Browse Projects</p>
              </button>
